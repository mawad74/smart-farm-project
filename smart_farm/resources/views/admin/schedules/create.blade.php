                        ...
                        <form method="POST" action="{{ route('admin.schedules.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('weather_forecast_integration') is-invalid @enderror" id="weather_forecast_integration" name="weather_forecast_integration" required>
                                    ...
                                    <option value="1" {{ old('weather_forecast_integration') == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('weather_forecast_integration') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('priority_zone') is-invalid @enderror" id="priority_zone" name="priority_zone" value="{{ old('priority_zone') }}">
                                @error('priority_zone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
