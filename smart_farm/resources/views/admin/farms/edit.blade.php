            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.farms.update', $farm->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="user_id" class="form-label">Owner (Farmer Manager)</label>
                                <select class="form-control @error('user_id') is-invalid @enderror" id="user_id" name="user_id" required>
                                    <option value="">Select Farmer Manager</option>
