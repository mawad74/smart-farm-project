            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.disease-detections.store') }}">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" min="0" max="1" class="form-control @error('confidence') is-invalid @enderror" id="confidence" name="confidence" value="{{ old('confidence') }}" required>
                                @error('confidence')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
