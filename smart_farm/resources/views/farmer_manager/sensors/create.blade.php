            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('farmer_manager.sensors.store') }}">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('light_intensity') is-invalid @enderror" id="light_intensity" name="light_intensity" value="{{ old('light_intensity') }}" step="0.1">
