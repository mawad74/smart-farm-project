            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('farmer_manager.schedules.update', $schedule->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('priority_zone') is-invalid @enderror" id="priority_zone" name="priority_zone" value="{{ old('priority_zone', $schedule->priority_zone) }}">
                                @error('priority_zone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
